...
%   Date:   1/15/2014
%   Function: compute latency, no retx; from send to sendDone
%%
...
% fprintf('debugging negative delay\n');
    if exist('link_seq_latency2.mat', 'file')
...
set(gca, 'xscale', 'log');
%%
save('link_seq_latency2.mat', 'link_seq_latency');
