...
for i = 1 : len
    ...
    for j = 1 : size(pdr_job, 1)
        ...
        % [sender receiver seqno tx_attempt_cnt tx_timestamp rx_timestamp
        % latency]
...
%
if is_median
    str = ['peer_retx_latency_median_bar_multihop'];
else
    str = ['peer_retx_latency_mean_bar_multihop'];
end
if ~is_neteye
    str = [str '_indriya'];
end
