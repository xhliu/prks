...
%   Date:   5/23/2013
%   Function: parse raw data w/ 16 bit node id (i.e., > 256 nodes)from Kansei w/
%   $Dropbox/Programming/parserKansei job#
%%
clear
clc
jobs = [5757];
...
DirDelimiter='/';
srcDir = '~/Projects/PRK/RawData/kansei';
% srcDir = '~/Downloads/Jobs/kansei';
