...
%   Date:   11/1/2013
%   Function: compute trimmed_link_pdrs (i.e., meet pdr requirement) and
%   display pdr vs pdr req for prks w/ heterogeneous pdr req
%% 
% us; 1 hour seems a good choice for neteye
% 0.5 for Indriya
CONVERGE_TIME_IN_HOUR = 2;
...
% %
% if is_neteye
%     str = ['prks_nama_pdr_vs_pdr_req_boxplot'];
% else
%     str = ['prks_nama_pdr_vs_pdr_req_indriya_boxplot'];
% end
% export_fig(str, '-eps');
