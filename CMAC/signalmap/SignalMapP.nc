...
//			total_interference = call SignalMap.dbmSumU(total_interference, CC2420_DEF_RFPOWER_DBM_SCALED - se->inbound_gain);
...
//			}
//			//total_interference = dbmSumU(total_interference, CC2420_DEF_RFPOWER_DBM - se->inbound_gain);
//			total_interference = call SignalMap.dbmSumU(total_interference, CC2420_DEF_RFPOWER_DBM - se->inbound_gain);
//			if (total_interference >= delta_i_d)
//				break;
//		}
//		
